...
- Plan Builder first presents a lightweight candidate-plan overview; when the final output is a durable artifact, Command Lead persists it under `<OPENCODE_CONFIG_DIR>/openplan/<session_key>/` and maintains `openplan/index.jsonl`.
